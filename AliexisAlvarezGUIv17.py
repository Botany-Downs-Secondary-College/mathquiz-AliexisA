...
class MathQuiz:
    ...
    def __init__(self, parent):
        ...
        self.TitleLabel = Label(self.frame1, bg = "black", fg = "white", width = 30, padx = 30, pady = 10, text="Welcome to MathQuiz", font=("Comic Sans MS", "16", "bold italic"))
        self.TitleLabel.grid(columnspan = 2)

        self.NameLabel = Label(self.frame1, text = "Name", width = 20, font=("Comic Sans MS", "14", "bold italic"))
        ...
        self.AgeLabel = Label(self.frame1, text = "Age", width = 20, font=("Comic Sans MS", "14", "bold italic"))
        ...
        self.SelectLabel = Label(self.frame1, text = "Select difficulty", width = 20, font=("Comic Sans MS", "14", "bold italic"))
        ...
        self.questions = Label(self.frame2, bg = "black", fg = "white", width = 30, padx = 30, pady = 10, text = "Quiz Questions", font=("Comic Sans MS", "14", "bold italic"))
        ...
        self.quiz_label = Label(self.frame2, text = "Problems", font = ("Comic Sans MS", "14", "bold italic"))
        ...
        for i in range(len(report_page)):
            lb = Label(self.report_frame, text = report_page[i], anchor = W, width = "7", height = "2", font = ("Comic Sans MS", "22", "bold"))
        ...
        try:
            if self.name.get() == "":
                ...
                self.NameEntry.focus()
                 ...
                 self.warning.configure(text = "Oh No! you are too old to play this game!!")
    ...
    def check_answer(self):
        try:
            ...
            if ans == self.answer:
                ...
                self.feedback.configure(text = "Wrong! Guess again!")
                self.AnswerEntry.delete(0, END)
                self.AnswerEntry.focus()
                self.next_problem()

        except ValueError:
            self.feedback.configure(text = "That is clearly not a number")
            self.AnswerEntry.delete(0, END)
            self.AnswerEntry.focus()
